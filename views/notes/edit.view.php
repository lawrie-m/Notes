<?php require base_path('views/partials/nav/head.php') ?>
<?php require base_path('views/partials/nav/nav.php') ?>
<?php require base_path('views/partials/nav/banner.php') ?>
...
<?php require base_path('views/partials/nav/footer.php') ?>